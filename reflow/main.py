...
def main() -> None:
    ...
    elif invoked_as == "git-sq":
        sys.argv.insert(1, "squash")
    elif invoked_as == "git-ra":
        sys.argv.insert(1, "--amend")
    # git-rf and git-rw are pass-through aliases for git-reflow
