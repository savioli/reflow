...
echo "    git reflow reword --claude            alias: git rw --claude"
echo "    git reflow reword HEAD~5 --claude"
echo ""
echo "  Reword checkpoint commits:"
echo "    git reflow reword checkpoint --claude alias: git rw ck --claude"
echo ""
echo "  Checkpoint:"
echo "    git reflow checkpoint                 alias: git ck"
echo ""
echo "  Squash checkpoints into one commit:"
echo "    git reflow --squash --claude          alias: git rf -s --claude"
echo ""
echo "  Amend last commit:"
echo "    git reflow --amend --claude           alias: git rf -a --claude"
echo ""
echo "  Rename branch:"
echo "    git reflow --branch --claude          alias: git rf -b --claude"
echo "    git reflow --branch --claude --prefix feature"
echo ""
echo "  Flags:"
